...
export default function TransactionDetailPage({ params }: TransactionDetailPageProps) {
  ...
  if (mounted && error) {
    return (
      <div className="space-y-4">
        <Link href="/transactions" className="flex items-center gap-2 text-muted-foreground hover:text-foreground">
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <Link href="/transactions" className="flex items-center gap-2 text-muted-foreground hover:text-foreground mb-4">
          <ArrowLeft className="h-4 w-4" />
          Back to Transactions
        </Link>
